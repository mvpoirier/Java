/*
 * An example of a self-balancing Binary Tree, based on user input data
 * Source: https://www.sanfoundry.com/java-program-create-balanced-binary-tree-incoming-data/
 */

import java.util.Scanner;

/*
 * Test program to demonstrate a self-balancing Binary Search Tree (BST)
 */

public class BinaryTreeSelfBalancing {
...
/*
 * Self-Balancing Binary Search Tree Node (SBBSTNodes)
 */
