...
public class HockeyGUI extends JFrame {
	...
	public static void main(String[] args) throws IOException {
		...
		// mockarooTeam: an imported team in a .csv file, delinated by tabs, from https://mockaroo.com/
		...
		while ((line = br.readLine()) != null && teamNum < 30) {
			...
			HockeyPlayer newPlayer = new HockeyPlayer(stats[0], stats[1], Integer.parseInt(stats[2]), stats[3], stats[4], Integer.parseInt(stats[5]));
		...
		Object[] options = {"Winnipeg Jets",
                "Mockaroo Team"};
		int n = JOptionPane.showOptionDialog(null,
		"Which fantasy team would you like to import?", "Team Choice",
