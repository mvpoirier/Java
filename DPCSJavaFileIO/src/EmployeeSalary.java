 ...
 * 
 * 			Employees are read from MOCK_DATA.csv and then a random salary is given,
 * 			This information is then written to output.txt
 */
...
public class EmployeeSalary {
	...
	public static void main(String[] args) throws IOException { // Need to throw IOE when reading or creating a file
		...
		FileWriter fw = new FileWriter("employee_salary.txt");
